import { findCourses, findLessonsForCourse } from './datas';
...
const MONGODB_CONNECTION_URL = 'mongodb+srv://jhhan:1han7107@cluster0.an5hm.mongodb.net';
...
client.connect(MONGODB_CONNECTION_URL, async (err, client) => {
  try {
